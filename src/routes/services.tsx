...
export const Route = createFileRoute("/services")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Full list of junk removal services in Dubai — furniture, appliances, mattresses, office and villa clearance, debris and e-waste. Same-day pickup." },
      { property: "og:title", content: "Junk Removal Services Dubai" },
      { property: "og:description", content: "Furniture, appliances, mattresses, clearances, debris, e-waste — handled across Dubai." },
