...
export const Route = createFileRoute("/privacy-policy")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "How we collect, use and protect your personal data when you use our Dubai junk removal service. UAE PDPL and GDPR aligned." },
...
const sections = [
  ...
  { h: "2. Information We Collect", b: [
    "Contact details: name, phone number, WhatsApp number, email address.",
    "Service details: pickup area, building/address, description and photos of items.",
  ...
  { h: "3. How We Use Your Information", b: [
    "To confirm and schedule pickups.",
    "To communicate with you via call, WhatsApp or email.",
    "To improve our service, website and customer experience.",
    "To comply with legal and regulatory obligations in the UAE.",
  ] },
  ...
  { h: "5. Sharing With Third Parties", b: [
    "Licensed disposal and recycling partners (job-related details only).",
    "Payment processors (for transactions).",
    "Analytics providers (anonymised data).",
