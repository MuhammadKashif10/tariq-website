...
export const Route = createFileRoute("/terms-conditions")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Terms governing our junk removal services in Dubai — bookings, liability, payment, cancellations and prohibited items." },
      { property: "og:url", content: absoluteUrl("/terms-conditions") },
    ],
    links: [{ rel: "canonical", href: absoluteUrl("/terms-conditions") }],
  }),
  component: Terms,
});
...
const sections = [
  ...
  { h: "3. Bookings & Confirmation", b: [
    "Bookings can be made via WhatsApp, phone, contact form or website.",
    "A booking is confirmed once we send written confirmation (WhatsApp/email).",
    "You are responsible for the accuracy of the address, access details and item description provided.",
  ] },
  { h: "4. Pricing & Payment", b: [
    "Prices are confirmed in writing before work begins, based on volume, access and labour.",
    "Payment is due on completion via cash, card or bank transfer.",
    "Late or unpaid balances may incur additional charges.",
  ] },
  { h: "5. Cancellations & Rescheduling", b: [
    "Free cancellation or rescheduling up to 2 hours before the scheduled slot.",
    "Cancellations inside the 2-hour window may incur a service fee.",
    "No-shows may be charged the full visit fee.",
  ] },
  ...
  { h: "7. Customer Responsibilities", b: [
    "Ensure items to be removed are accessible.",
    "Obtain building/community permissions where required.",
    "Remove personal valuables before pickup; we are not liable for items inside discarded furniture.",
  ] },
  { h: "8. Liability", b: [
    "We carry insurance and take all reasonable care.",
    "Our liability is limited to direct damages caused by our proven negligence, capped at the value of the specific job.",
